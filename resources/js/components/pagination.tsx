      ...
      <div className="flex items-center space-x-6 lg:space-x-8">
        <div className="flex items-center space-x-2">
          ...
          <Select value={`${paginated.per_page}`} onValueChange={onPerPageChange}>
            <SelectTrigger className="h-8 w-[70px] border border-border">
        ...
        <div className="flex items-center space-x-2">
          ...
          <Button
            ...
            onClick={() => handleVisit(String(paginated.first_page_url))}
          ...
          <Button
            ...
            onClick={() => handleVisit(String(paginated.prev_page_url))}
            disabled={!paginated.prev_page_url}
          >
          ...
          <Button
            variant="outline"
            className="h-8 w-8 p-0"
            onClick={() => handleVisit(String(paginated.next_page_url))}
          ...
          <Button
            variant="outline"
            className="hidden h-8 w-8 p-0 lg:flex"
            onClick={() => handleVisit(String(paginated.last_page_url))}
            disabled={!paginated.next_page_url}
          >
