...
// This interface defines the shape of a behavior rule in our form's state.
// We add a unique 'ruleId' to help React manage the list of rules efficiently.
...
export function TicketStatusFormModal({
  ...
  // Adds a new, empty tag rule to the state.
  ...
  // Removes a specific tag rule from the state using its temporary UI ID.
  ...
  // Updates the selected tag for a specific rule.
    ...
    <>
      <Dialog open={isOpen} onOpenChange={onOpenChange}>
        <DialogContent className="bg-popover sm:max-w-lg">
          ...
          <form id="ticket-status-form" onSubmit={onSubmit} className="grid gap-4 py-4" autoComplete="off">
            {/* Name Input */}
