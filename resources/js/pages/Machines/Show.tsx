...
// Se definen los tipos de datos para las props de la página
...
interface ShowPageProps {
    ...
    stats: any;
    // ACTION: Se añade la nueva prop 'healthScores'
    healthScores: {
        today: HealthStats;
        week: HealthStats;
        month: HealthStats;
...
export default function Show({
    ...
    uptime,
    stats,
    // ACTION: Se recibe la nueva prop 'healthScores'
    healthScores,
    allMaintenances,
    maintenanceFilters,
        ...
        <AppLayout breadcrumbs={breadcrumbs}>
            ...
            <div className="space-y-6 p-6">
                <MachineHeader
                    ...
                    stats={stats}
                    uptime={uptime}
                    // ACTION: Se pasa la nueva prop 'healthScores' al componente del encabezado
